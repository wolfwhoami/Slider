...
namespace Slider
{
    public static class SliderHandler
    {
        ...
        {
            var filePath = Path.Combine(new DirectoryInfo(System.AppDomain.CurrentDomain.BaseDirectory).Parent.Parent.Parent.FullName, "test","companyname.txt");
            var companyNames = File.ReadAllLines(filePath);
        ...
        /// <returns></returns>
        private static Image GetSubImage(InternetExplorerDriver driver, IWebElement iWebElement)
        {
